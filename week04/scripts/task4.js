...
// Step 7: Inside of the empty array above, add a new object with two properties: place and length, and add values of an empty string
// Step 8: For each property, add appropriate values as strings
// Step 9: Add additional objects with the same properties for each place you've lived
const infoAboutSelf = {
    name: "M Abdul Mahlangu",
    photo: "images/mainImage.png",
    favoriteFoods: ["Spicey Rice", "Pizza", "Fried Fish", "Pasta"],
...
document.getElementById("name").innerHTML = infoAboutSelf.name;

// Step 2: Assign the value of the photo property as the src attribute of the HTML <img> element with an ID of photo
// Step 3: Assign the value of the name property as the alt attribute of the HTML <img> element with an ID of photo
document.getElementById("photo").setAttribute("src", infoAboutSelf.photo);
